...
const getDogsByCode:any = express.Router();
...
getDogsByCode.get("/:statusCode",async(req:any,res:any):Promise<any>=>{
    ...
    try{
        ...
        const results:any = await db.collection('dogs').find(
            {

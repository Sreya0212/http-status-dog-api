...
var deleteTasks = express.Router();
//Create a POST Mode request to insert users in DB
deleteTasks.delete('/:title', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var clientObj, db, title, result, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, db.collection('todo').deleteOne({
                        'title': title
                    })];
            case 2:
                result = _a.sent();

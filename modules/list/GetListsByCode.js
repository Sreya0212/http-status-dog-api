...
var getListsByCode = express.Router();
//Get the MongoURI
...
getListsByCode.get("/:statusCode", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, db.collection('list').find({
...
//export the module
exports.default = getListsByCode;
